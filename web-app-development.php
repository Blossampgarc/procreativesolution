    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="txtwrap">
          ...
          <p>The seamless user experience will make you love your product as much as your customers do <br><br>With Pro Creative solution as your web development agency, you receive: qualified web resources, user-centric solutions, state-of-the-art facilities, a standardized approach, authorized credentials and a proven track record.</p>
          <ul class="whatlist">
            <li>
              <figure>
