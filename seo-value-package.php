...
<div class="container">
  ...
  <div class="row">
  	<div class="col-lg-4 col-md-4 col-sm-4">
          ...
          <h6><span class="old">£800.00</span> £400.00  <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for mid-level startups and organizations.</span></h6>
          
        <a href="orderd71b.php?pack=24" class="ordrrrr">Place Your Order</a>
          ...
          <div class="table-packages bronze">
            ...
            <div class="body">
              <ul class="subscription-list">
                  ...
                  <li><h6>Business Analysis</h6>
                  <span class="tick"></span></li>
                  <li><h6>Consumer Analysis</h6>
                  <span class="tick"></span></li>
                  <li><h6>Competitor Analysis</h6>
                  <span class="tick"></span></li>
                  <li><h6>15 Selected Keywords Targeting</h6>
                  <span class="tick"></span></li>
                  <li><h6>15 Pages Keyword Targeted</h6>
                  <span class="tick"></span></li>
                  <li class="heading">Webpage</li>
                  <li><h6>Meta Tags Creation</h6>
                  <span class="tick"></span></li>
                  <li><h6>Keyword Optimization</h6>
                  <span class="tick"></span></li>
                  <li><h6>Image Optimization</h6>
                  <span class="tick"></span></li>
                  <li><h6>Inclusion of anchors</h6>
                  <span class="tick"></span></li>
                  <li class="heading">Tracking and analysis </li>
                  <li><h6>Google Analytics Installation</h6>
                  <span class="tick"></span></li>
                  <li><h6>Google Webmaster Installation</h6>
                  <span class="tick"></span></li>
                  <li><h6>Call To Action Plan</h6>
                  <span class="tick"></span></li>
                  <li><h6>Creation of Sitemaps</h6>
                  <span class="tick"></span></li>
