...
<div class="container">
  ...
  <div class="row">
  	<div class="col-lg-4 col-md-4 col-sm-4">
          ...
          <h6><span class="old">£3998.00</span> £1999.00  <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for mid-level startups and organizations.</span></h6>
          
        <a href="orderaecd.php?pack=26" class="ordrrrr">Place Your Order</a>
          ...
          <div class="table-packages bronze">
            ...
            <div class="body">
              <ul class="subscription-list">
                ...
                <li><h6>15 Seconds 2D Explainer Video</h6> <span class="tick"></span></li>
                <li><h6>Voice - Over &amp; Sound Effects</h6> <span class="tick"></span></li>
                <li><h6>Professional Script Writing</h6> <span class="tick"></span></li>
                <li><h6>Storyboard</h6> <span class="tick"></span></li>
                <li><h6>SEO Meta Tags</h6> <span class="tick"></span></li>
                <li><h6>15 to 20 Pages Website</h6> <span class="tick"></span></li>
                <li><h6>Custom Made, Interactive, Dynamic &amp; High End Design</h6> <span class="tick"></span></li>
                <li><h6>Custom WP (or) Custom PHP Development</h6> <span class="tick"></span></li>
                <li><h6>1 jQuery Slider Banner</h6> <span class="tick"></span></li>
                <li><h6>Up to 10 Custom Made Banner Designs</h6> <span class="tick"></span></li>
                <li><h6>10 Stock Images</h6> <span class="tick"></span></li>
                <li><h6>Unlimited Revisions</h6> <span class="tick"></span></li>
                <li><h6>Special Hoover Effects</h6> <span class="tick"></span></li>
                <li><h6>Content Management System (CMS)</h6> <span class="tick"></span></li>
                <li><h6>Online Appointment/Scheduling/Online Ordering Integration (Optional)</h6> <span class="tick"></span></li>
                <li><h6>Online Payment Integration (Optional)</h6> <span class="tick"></span></li>
                <li><h6>Multi Lingual (Optional)</h6> <span class="tick"></span></li>
                <li><h6>Custom Dynamic Forms (Optional)</h6> <span class="tick"></span></li>
                <li><h6>Signup Area (For Newsletters, Offers etc.)</h6> <span class="tick"></span></li>
                <li><h6>Search Bar</h6> <span class="tick"></span></li>
                <li><h6>Live Feeds of Social Networks integration (Optional)</h6> <span class="tick"></span></li>
                ...
                <li><h6>Industry Specified Team of Expert Designers and Developers</h6> <span class="tick"></span></li>
                <li><h6>Complete Deployment</h6> <span class="tick"></span></li>
                <li><h6>Dedicated Accounts Manager</h6> <span class="tick"></span></li>
