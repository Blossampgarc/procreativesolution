          ...
          <div class="row">
            <div class=" col-lg-5">
              <div class="home-banner-content">
                ...
                <a href="order.php" class="btn-theme">Get a Design Now </a>
              </div>
            </div>
          </div>
        </div>
...
<section class="servicesec">
  ...
  <div class="left">
    ...
    <p>Video is the most effective medium to communicate in today’s time. At Pro Creative solution, we believe in creating animated videos that are derived out of the essence of your brand. Pro Creative solution works through videos to help you create, promote and sell.</p>
    ...
    <a href="order.php" class="btn-theme">Animate in just £209.99 </a>
  </div>
  <div class="right">
    <figure>
          ...
          <div id="mobileapp" class="tab-pane">
            <div class="largebox">
              <div class="leftarea">
                ...
                <a href="custom-quote.php" class="btn-packages">Get a Custom Quote</a>
              </div>
              <div class="rightarea">
                ...
                <ul class="ticklist">
                  ...
                  <li class="ralign">
                    ...
                    <a href="tel:+11-2345-678-910"><h6>+11-2345-678-910</h6></a>
                  </li>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="wrap">
           ...
           <a class="gt-strt" href="order.php" class="btn-secondary-outline">Get Started </a>
