    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="margin-bottom-20">
          ...
          <p>At WEBDESIGNSAGA, the privacy of our clients is our top priority on <a href="index.php" target="_blank">www.webdesignsaga.co.uk </a> and we respect it as our own. Though we collect information from our clients, it is only used to make improvements in our customer services. Our company acknowledges that the maintenance and use of our clients' information is our responsibility. We DO NOT rent or sell the information that our clients provide us online.</p>
        ...
        <div class="margin-bottom-20">
          ...
          <p>If you have any questions about security on our Web site, you can send email us at <a href="mailto:support@procreativesolution.co.uk">support@procreativesolution.co.uk</a></p>
        </div>
        <div class="margin-bottom-20">
        ...
        <div class="margin-bottom-20">
          <h3>Questions</h3>
          <p>If you have any questions regarding our Privacy Policy or our use of your information, call our toll free number (+44-016-1884-0966) or email us on <a href="mailto:support@procreativesolution.co.uk">support@procreativesolution.co.uk</a></p>
         <p>In order to ensure the privacy of our valued customer we never store any sort of information related 
to our clients neither we do take any cards information from client.</p>
         </div>
      </div>
    </div>
  </div>
