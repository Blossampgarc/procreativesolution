...
<div class="container">
  ...
  <div class="row">
  	<div class="col-lg-4 col-md-4 col-sm-4">
          ...
          <h6><span class="old">£400.00</span> £200.00  <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for potential super-startups and brand revamps for companies.</span></h6>
          
        <a href="order9cb8.php?pack=23" class="ordrrrr">Place Your Order</a>
          ...
          <div class="table-packages bronze">
            ...
            <div class="body">
              <ul class="subscription-list">
                  ...
                  <li><h6>Website Audit</h6>
                  <span class="tick"></span></li>
                  <li><h6>Pages Optimized (10 pages) </h6>
                  <span class="tick"></span></li>
                  <li><h6>Keyword Research</h6>
                  <span class="tick"></span></li>
                  <li><h6>Keyword Grouping</h6>
                  <span class="tick"></span></li>
                  <li><h6>Keyword Mapping</h6>
                  <span class="tick"></span></li>
                  <li class="heading">On-Page Optimization</li>
                  <li><h6>SEO Road Map</h6>
                  <span class="tick"></span></li>
                  <li><h6>Blog Creation</h6>
                  <span class="tick"></span></li>
                  <li><h6>Webpage Copywriting (3 pages, 350 words per page)</h6>
                  <span class="tick"></span></li>
                  <li><h6>Title Tag Optimization (10 titles)</h6>
                  <span class="tick"></span></li>
                  <li><h6>Meta Description Optimization (10 meta description)</h6>
                  <span class="tick"></span></li>
                  <li><h6>Meta Keyword Optimization (10 meta keywords)</h6>
                  <span class="tick"></span></li>
                  <li><h6>Domain Redirect Optimization (10 domain redirects)</h6>
                  <span class="tick"></span></li>
                  <li><h6>xml Sitemap Optimization</h6>
                  <span class="tick"></span></li>
                  <li><h6>Robots.txt Check</h6>
                  <span class="tick"></span></li>
                  <li><h6>URL Rewrites (10 URL rewrites)</h6>
                  <span class="tick"></span></li>
                  <li><h6>Broken Link Report</h6>
                  <span class="tick"></span></li>
                  <li class="heading">Rich Snippet Recommendations</li>
                  <li><h6>Breadcrumbs</h6>
                  <span class="tick"></span></li>
                  <li class="heading">Initial Off-Page SEO</li>
                  <li><h6>Social Bookmarking</h6>
                  <span class="tick"></span></li>
                  <li><h6>Slide Share Marketing</h6>
                  <span class="tick"></span></li>
                  <li><h6>Forums/FAQ’s</h6>
                  <span class="tick"></span></li>
                  <li><h6>Link Building</h6>
                  <span class="tick"></span></li>
                  <li><h6>Directory Submission</h6>
                  <span class="tick"></span></li>
                  <li><h6>Local Business Listings</h6>
                  <span class="tick"></span></li>
              </ul>
            </div>
          </div>
