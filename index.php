...
<div class="container">
  ...
  <div class="container">
    <div class="row">
      <div class="">
        <div class="ban-form">
          <form class="cmxform" id="bannerform"  method="POST" action="https://procreativesolution.co.uk/webpages/bannerFormController.php">
            ...
            <div class="row">
              ...
              <div class="col-lg-12">
                <div class="fldset">
                  ...
                  <div class="g-recaptcha" data-sitekey="6LePyNEcAAAAAIYtJRY8euGK2CPRR9n1zWSnvTHF"></div>
              ...
              <input type="hidden" id="location" name="locationURL" value="http://webdesignsaga.co.uk/" />
                </div>
              </div>
            </div>
          </form>
          ...
          <div class="row">
            <div class=" col-lg-7">
              <div class="home-banner-content ">
                ...
                <div class="mybtnwrap">
                  <a href="order.php" class="btn-theme-outline">Get Your Web Design </a>
                </div>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="wrap">
           ...
           <a class="gt-strt" href="order.php">Get Started </a>
            <a class="new-cta" href="tel:+11-2345-678-910">+11-2345-678-910 </a>
         ...
         <ul class="testwrap sldrtstmnl">
          ...
          <li>
            <div class="testbox">
              ...
              <!--</div>-->
              <div class="usertest">
                <h4>Big Shout-out to the webdesignsaga Team!!</h4>
          ...
          <li>
            <div class="testbox">
              ...
              <div class="usertest">
                ...
                <p>I want to thank webdesignsaga team for doing such a great job on our Website, it was easy and phenominal. Thankyou very much and looking forward to doing business with webdesignsaga in the future. </p>
