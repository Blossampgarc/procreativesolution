...
<p>In any event, any deposited funds for a project shall not be subject to refund after delivery if the initial design concepts are approved, or a change is requested unless webdesignsaga cancels or terminates your Contract for a reason other than your breach or non-performance. </p>
...
<ul>
        <p> <strong>All refund requests will be fulfilled as per the following arrangement:</strong></p>
         ...
         <li>  All refund requests should be communicated to the support department. Webdesignsaga, based on the violation of your user agreement reserves the right to approve/disapprove your request on an individual case to case basis. </li>
         <li>  For Webdesignsaga / Custom packages, refund will be applicable the same as it is on the single packages. 
</li>
...
<p><strong>How to claim your refund</strong></p>
         ...
         <ul>
          <li>  Claim your refund specifying your concern by contacting us via any of the following three modes:
            <ul>
             ...
             <li>  Live Chat</li>
             <li>  <a href="mailto:support@procreativesolution.co.uk">support@procreativesolution.co.uk</a></li>
            </ul>
          </li>  
           <li>  We will try to resolve your concern by virtue of our revision policy immediately or else will email you a refund request approval from our refund department. After the refund, your design rights would be obtained by webdesignsaga and you would not be able to display any version of the design sent by company. Let us also specify that:
            <ul>
               ...
               <li>  Working in collaboration with the Government Copyright Agencies pro creative solution would share Copyright Acquisition information for the refunded designs that would restrict the re-use of the designs as original designs in the future.
               
               If you have any questions or concerns about our Refund Policy, please contact us by clicking here <a href="mailto:support@procreativesolution.co.uk">support@procreativesolution.co.uk</a>.
               </li>
            </ul>
           </li>
         </ul>
        ...
        <p>The representatives may use the pseudo names depending on which region they are interacting in 
order to facilitate and do a better communication with our customers because we deal in the global market.</p>
    </div>
