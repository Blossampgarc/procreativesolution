  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-3">
        <div class="logo">
            <a href="index.php">
              <img class="img-fluid black" src="assets/images/new_logo.png" alt="*" />
            </a>
          </div>
      </div>
      <div class="col-lg-9">
...
<div class="slider-wrapper black">
  ...
  <p>Heads up! We require that you sign up for Pro Creative solution  services and packages. We make all your dreams come true in a successful project.</p>
  <form class="cmxform" id="contactForm"  method="POST" action="https://procreativesolution.co.uk/webpages/orderFormController.php"  enctype="multipart/form-data">
    ...
    <div class="row">
     ...
     <div class="col-md-12">
         <div class="forarrowselect">
            ...
            <select name="Packages" id="packages" disabled="" readonly="" class="valid safari_only" aria-invalid="false" >
